...
public class UploadAdapter_backup extends ArrayAdapter<Allo> {
    ...
    public UploadAdapter_backup(Context context, int textViewResourceId, List<Allo> objects, UploadFragment mUploadFragment) {
        ...
        this.mUploadFragment = mUploadFragment;
    }
